...
model = load_model('../model_aug_best.keras')

# Define class labels
class_labels = {0: 'happy', 1: 'sad', 2: 'surprise'}

# Define the image upload and prediction function
def predict_image(img):
    img = image.load_img(img, target_size=(250, 250))  # Adjust target_size as per your model
...
def run():
    st.title('Klasifikasi Eskpresi Wajah')
